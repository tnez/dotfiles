...
It should only modify the values of Spacemacs settings."
  ...
  (setq-default
   ...
   ;; One of `spacemacs', `all-the-icons', `custom', `vim-poweriline', or `vanila'
   ...
   ;;                             :width normal
   ;;                             :powerline-scale 1.1)
   dotspacemacs-default-font (if (and window-system (> (x-display-pixel-width) 1680))
                                 '("Fira Code" :size 18 :weight normal :width normal :powerline-scale 1)
                               '("Fira Code Retina" :size 12 :weight normal :width normal :powerline-scale 1))
   ;; The leader key
...
before packages are loaded."
  ...
  ;; disable all color thems before switching to a new one
